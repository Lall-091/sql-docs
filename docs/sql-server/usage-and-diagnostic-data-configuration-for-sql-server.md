...
- For SQL Server Management Studio 17 and SQL Server Management Studio 18, refer to [User Assistance in SQL Server Management Studio](/ssms/sql-server-management-studio-telemetry-ssms)
