...
<sup>1</sup> This feature is [removed](/lifecycle/definitions#removal) in [!INCLUDE [sssql25-md](../includes/sssql25-md.md)]. We continue to support this feature in [!INCLUDE [sssql22-md](../includes/sssql22-md.md)] and earlier versions.
