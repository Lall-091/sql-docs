...
- Check out the new [Wide World Importers sample databases for Microsoft SQL](../samples/wide-world-importers-what-is.md) sample available on the [sql-server-samples](https://github.com/Microsoft/sql-server-samples) GitHub repository.
...
| [Enterprise Information Management (EIM) Tutorials](https://help.sap.com/docs/SUPPORT_CONTENT/eim/3361406342.html) | Learn how to manage information in an enterprise using Microsoft EIM technologies. |
...
| [R tutorials for SQL machine learning](../machine-learning/tutorials/r-tutorials.md) | Learn how to work with [!INCLUDE [ssNoVersion](../includes/ssnoversion-md.md)] data using R or Python. Run R or Python scripts from [!INCLUDE [tsql](../includes/tsql-md.md)]. |
