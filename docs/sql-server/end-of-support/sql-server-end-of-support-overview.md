...
**End of support** (also sometimes known as end of life) means that a product reached the end of its lifecycle. Microsoft no longer provides servicing and support for the product. For more information about the Microsoft Lifecycle, see [Microsoft Lifecycle Policy](/lifecycle).
...
- [Migrate](/azure/azure-sql/migration-guides/) your workload to [Azure SQL](/azure/azure-sql/azure-sql-iaas-vs-paas-what-is-overview).
...
The following table provides migration options for a [!INCLUDE [ssnoversion-md](../../includes/ssnoversion-md.md)] instance that is out of extended support and running on-premises.
...
| Move to IaaS with SQL Server on Azure VM | **Upgrade** to latest SQL Server on Azure VMs, or **move [!INCLUDE [sssql14-md](../../includes/sssql14-md.md)] "as-is"**, and get three years of Extended Security Updates for free. |
...
- [SQL Server 2025](../what-s-new-in-sql-server-2025.md)
...
- [SQL Server 2025](../install/hardware-and-software-requirements-for-installing-sql-server-2025.md)
...
- [SQL Server 2025](../../database-engine/install-windows/supported-version-and-edition-upgrades-2025.md)
...
- **Transact-SQL differences**: Some [!INCLUDE [tsql](../../includes/tsql-md.md)] (T-SQL) differences exist between SQL managed instance and on-premises [!INCLUDE [ssNoVersion](../../includes/ssnoversion-md.md)].
...
- [SQL Database feature comparison](/azure/azure-sql/database/features-comparison)
...
- [SQL Server migration in Azure Arc](../azure-arc/migration-overview.md)
...
- **Free Extended Security Updates**: If you choose to keep your [!INCLUDE [ssNoVersion](../../includes/ssnoversion-md.md)] as-is, using [!INCLUDE [sssql14-md](../../includes/sssql14-md.md)], you can get free Extended Security Updates for three years past the end of support date, even without having Software Assurance.
...
If you want to offload maintenance, reduce costs, and eliminate the need to upgrade in the future, move your workload to [Azure SQL Database](/azure/azure-sql/database/sql-database-paas-overview). This option is best for modern cloud applications that want to use the latest stable [!INCLUDE [ssDEnoversion](../../includes/ssdenoversion-md.md)] features and have time constraints in development and marketing.
...
- **Feature limitation**: Although the most commonly used Azure SQL Database features are available, the feature set for a database isn't as complete as for Azure SQL Managed Instance, or [!INCLUDE [ssNoVersion](../../includes/ssnoversion-md.md)].
- **Transact-SQL differences**: There are some [!INCLUDE [tsql](../../includes/tsql-md.md)] (T-SQL) differences between a database and an on-premises [!INCLUDE [ssNoVersion](../../includes/ssnoversion-md.md)].
