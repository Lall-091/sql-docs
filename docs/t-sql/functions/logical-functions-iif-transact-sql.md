...
[!INCLUDE [SQL Server Azure SQL Database Azure SQL Managed Instance Fabric SE/DW FabricSQLDB](../../includes/applies-to-version/sql-asdb-asdbmi-fabricse-fabricdw-fabricsqldb.md)]
