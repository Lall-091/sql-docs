...
-   Define expressions that provide you with the ability to customize how report data is filtered, grouped, and sorted.  
    ...
    :::image type="content" source="../report-builder/media/report-builder-in-sql-server/rs-getting-started-report.png" alt-text="Screenshot of Getting Started Report.":::
