---
title: "Configure Multiple-Subnet Availability Group and FCI (Linux)"
...
ms.reviewer: amitkh, atsingh, mikeray
ms.date: 01/02/2026
ms.service: sql
ms.subservice: linux
ms.topic: how-to
...
:::image type="content" source="media/configure-multiple-subnet/multi-subnet-virtual-network-diagram.png" alt-text="Diagram of a multi-subnet configuration using a VLAN with servers at two sites sharing a single availability group or FCI IP address.":::
...
:::image type="content" source="media/configure-multiple-subnet/multi-subnet-pacemaker-diagram.png" alt-text="Diagram of a multi-subnet configuration using Pacemaker, with two servers at Site A on subnet 192.168.1.x and one server at Site B on subnet 192.168.2.x, with AG or FCI IP addresses on each subnet.":::
...
- [Configure multiple-subnet Always On Availability Group by modifying CIB](https://techcommunity.microsoft.com/blog/sqlserversupport/configure-multiple-subnet-alwayson-availability-group-by-modifying-cib/1544838)
