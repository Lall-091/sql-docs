...
:::image type="content" source="media/cross-platform/cluster-type-none.png" alt-text="Diagram of Availability group with cluster type of None.":::
...
1. Install [!INCLUDE [sssql22-md](../../../includes/sssql22-md.md)] on Windows Server 2022, enable **Always On Availability Groups** from SQL Server Configuration Manager, and set mixed mode authentication.
   ...
   **Enable Availability Groups**
   ...
   :::image type="content" source="media/cross-platform/configuration-manager.png" alt-text="Screenshot showing how to enable Availability Groups." lightbox="media/cross-platform/configuration-manager.png":::
...
1. Set the group and ownership of the private key and the certificate to `mssql:mssql`.
   ...
   :::image type="content" source="media/cross-platform/certificate-key-owner-group.png" alt-text="Screenshot of a Git Bash window showing the .cer and the .pvk in the /var/opt/mssql/data folder.":::
