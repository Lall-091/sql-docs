...
- [Configure SQL Server availability group for high availability on Linux](availability-groups/configure.md)
- [Always On availability group failover on Linux](availability-groups/failover-high-availability.md)
