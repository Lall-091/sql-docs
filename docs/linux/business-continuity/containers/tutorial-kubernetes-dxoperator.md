...
1. In AKS, create the `configmap` object, which has **[mssql-conf](../../configure/mssql-conf.md)** settings based on your requirements. In this example, you create the `configMap`, using a file called `mssqlconfig.yaml` with the following parameters.
