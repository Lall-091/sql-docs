...
:::image type="content" source="media/shared-disk-cluster-configure-iscsi/05-initiator.png" alt-text="Screenshot of the iSCSI target properties dialog for linuxnodes1, showing the Initiators tab with IP addresses assigned to the target." lightbox="media/shared-disk-cluster-configure-iscsi/05-initiator.png":::
...
1. Edit `/var/lib/iscsi/ifaces/iSCSIIfaceName`. Make sure it has the following values completely filled out:
   ...
   :::image type="content" source="media/shared-disk-cluster-configure-iscsi/10-iscsitargetsettings.png" alt-text="Screenshot of the file with the values completely filled out.":::
...
1. Check iSCSI attached disks.
   ...
   :::image type="content" source="media/shared-disk-cluster-configure-iscsi/30-iscsiattacheddisks.png" alt-text="Screenshot of the grep command and the response to the command showing the attached SCSI disks.":::
...
1. For system databases or anything stored in the default data location, follow these steps. Otherwise, skip to Step 13.
   ...
   1. Verify that the files have been deleted. The following image shows an example of the entire sequence from c through h.
      ...
      :::image type="content" source="media/shared-disk-cluster-configure-iscsi/45-copymove.png" alt-text="Screenshot of the ls command and the response to the command." lightbox="media/shared-disk-cluster-configure-iscsi/45-copymove.png":::
