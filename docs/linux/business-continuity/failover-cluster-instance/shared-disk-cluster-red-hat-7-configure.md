...
:::image type="content" source="media/shared-disk-cluster-red-hat-7-configure/linux-cluster.png" alt-text="Diagram of Red Hat Enterprise Linux 7 shared disk SQL Server cluster.":::
...
1. Install and setup [!INCLUDE [ssnoversion-md](../../../includes/ssnoversion-md.md)] on both nodes. For detailed instructions, see [Installation guidance for SQL Server on Linux](../../install-upgrade/setup.md).
