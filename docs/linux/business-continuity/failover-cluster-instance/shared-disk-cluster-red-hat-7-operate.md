...
:::image type="content" source="media/shared-disk-cluster-red-hat-7-operate/linux-cluster.png" alt-text="Diagram of Red Hat Enterprise Linux 7 shared disk SQL Server cluster.":::
...
- [Configure RHEL failover cluster instance (FCI) cluster for SQL Server](shared-disk-cluster-red-hat-7-configure.md)
