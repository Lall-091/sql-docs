...
This article describes how to configure the time zone for [!INCLUDE [sssql19-md](../includes/sssql19-md.md)] on Linux. You can also configure the time zone on Linux for [SQL Server 2017](sql-server-linux-configure-time-zone-2017.md), and [SQL Server 2022 and later versions](sql-server-linux-configure-time-zone.md).
