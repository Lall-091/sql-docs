...
For instructions on how to configure repositories for [!INCLUDE [sssql25-md](../../includes/sssql22-md.md)] and later versions, see [Configure repositories for installing and upgrading SQL Server 2025 on Linux](change-repo-2025.md?view=sql-server-ver17&preserve-view=true).
