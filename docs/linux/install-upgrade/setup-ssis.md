...
1. After installation, run **ssis-conf**. For more info, see [Configure SQL Server Integration Services on Linux with ssis-conf](../migrate/configure-ssis.md).
...
1. After installing Integration Services, run **ssis-conf**. For more info, see [Configure SQL Server Integration Services on Linux with ssis-conf](../migrate/configure-ssis.md).
...
- [Configure SQL Server Integration Services on Linux with ssis-conf](../migrate/configure-ssis.md)
- [Feature support and considerations for SQL Server Integration Services (SSIS) on Linux](../migrate/ssis-known-issues.md)
- [Schedule SQL Server Integration Services package execution on Linux with cron](../migrate/schedule-ssis-packages.md)
