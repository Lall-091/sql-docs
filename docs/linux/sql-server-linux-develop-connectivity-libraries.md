...
| Python | Windows, Linux, macOS | [mssql-python](../connect/python/mssql-python/python-sql-driver-mssql-python.md) | [Install](../connect/python/mssql-python/python-sql-driver-mssql-python-quickstart.md#install-the-mssql-python-package) | [Get started](../connect/python/mssql-python/python-sql-driver-mssql-python.md) |
