...
This article describes how to configure the time zone for [!INCLUDE [sssql22-md](../../includes/sssql22-md.md)] and later versions on Linux. You can also configure the time zone on Linux for [SQL Server 2017](time-zone-2017.md) and [SQL Server 2019](time-zone-2019.md).
