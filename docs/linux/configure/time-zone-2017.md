...
This article describes how to configure the time zone for [!INCLUDE [sssql17-md](../../includes/sssql17-md.md)] on Linux. You can also configure the time zone on Linux for [SQL Server 2019](time-zone-2019.md), and [SQL Server 2022 and later versions](time-zone.md).
