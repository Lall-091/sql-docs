...
This section lists the latest versions of each package per distribution, for [!INCLUDE [ssSQL19](../includes/sssql19-md.md)]. The following table shows the most recent release, which is **CU 32 GDR (May 2026)**. For full release history, see [Release history for SQL Server 2019 on Linux](/troubleshoot/sql/releases/linux/release-history-2019).

| Version | Release | Date | Build | KB article |
| --- | --- | --- | --- | --- |
| [!INCLUDE [ssSQL19](../includes/sssql19-md.md)] | CU 32 GDR | 2026-05-12 | 15.0.4470.1 | [KB 5090407](https://support.microsoft.com/help/5090407) |
...
| RHEL 8 | Database Engine | 15.0.4470.1-12 | [Database Engine RPM package](https://packages.microsoft.com/rhel/8/mssql-server-2019/Packages/m/mssql-server-15.0.4470.1-12.x86_64.rpm) |
| RHEL 8 | Extensibility | 15.0.4470.1-12 | [Extensibility RPM package](https://packages.microsoft.com/rhel/8/mssql-server-2019/Packages/m/mssql-server-extensibility-15.0.4470.1-12.x86_64.rpm) |
| RHEL 8 | Full-Text Search | 15.0.4470.1-12 | [Full-Text Search RPM package](https://packages.microsoft.com/rhel/8/mssql-server-2019/Packages/m/mssql-server-fts-15.0.4470.1-12.x86_64.rpm) |
| RHEL 8 | High Availability | 15.0.4470.1-12 | [High Availability RPM package](https://packages.microsoft.com/rhel/8/mssql-server-2019/Packages/m/mssql-server-ha-15.0.4470.1-12.x86_64.rpm) |
| RHEL 8 | Java Extensibility | 15.0.4470.1-12 | [Java Extensibility RPM package](https://packages.microsoft.com/rhel/8/mssql-server-2019/Packages/m/mssql-server-extensibility-java-15.0.4470.1-12.x86_64.rpm) |
| RHEL 8 | PolyBase | 15.0.4470.1-12 | [PolyBase RPM package](https://packages.microsoft.com/rhel/8/mssql-server-2019/Packages/m/mssql-server-polybase-15.0.4470.1-12.x86_64.rpm) |
...
| SLES 15 | Database Engine | 15.0.4470.1-12 | [Database Engine RPM package](https://packages.microsoft.com/sles/15/mssql-server-2019/Packages/m/mssql-server-15.0.4470.1-12.x86_64.rpm) |
| SLES 15 | Extensibility | 15.0.4470.1-12 | [Extensibility RPM package](https://packages.microsoft.com/sles/15/mssql-server-2019/Packages/m/mssql-server-extensibility-15.0.4470.1-12.x86_64.rpm) |
| SLES 15 | Full-Text Search | 15.0.4470.1-12 | [Full-Text Search RPM package](https://packages.microsoft.com/sles/15/mssql-server-2019/Packages/m/mssql-server-fts-15.0.4470.1-12.x86_64.rpm) |
| SLES 15 | High Availability | 15.0.4470.1-12 | [High Availability RPM package](https://packages.microsoft.com/sles/15/mssql-server-2019/Packages/m/mssql-server-ha-15.0.4470.1-12.x86_64.rpm) |
| SLES 15 | Java Extensibility | 15.0.4470.1-12 | [Java Extensibility RPM package](https://packages.microsoft.com/sles/15/mssql-server-2019/Packages/m/mssql-server-extensibility-java-15.0.4470.1-12.x86_64.rpm) |
| SLES 15 | PolyBase | 15.0.4470.1-12 | [PolyBase RPM package](https://packages.microsoft.com/sles/15/mssql-server-2019/Packages/m/mssql-server-polybase-15.0.4470.1-12.x86_64.rpm) |
| **Ubuntu** | | | |
| Ubuntu 20.04 | Database Engine | 15.0.4470.1-12 | [Database Engine Debian package](https://packages.microsoft.com/ubuntu/20.04/mssql-server-2019/pool/main/m/mssql-server/mssql-server_15.0.4470.1-12_amd64.deb) |
| Ubuntu 20.04 | Extensibility | 15.0.4470.1-12 | [Extensibility Debian package](https://packages.microsoft.com/ubuntu/20.04/mssql-server-2019/pool/main/m/mssql-server-extensibility/mssql-server-extensibility_15.0.4470.1-12_amd64.deb) |
| Ubuntu 20.04 | Full-Text Search | 15.0.4470.1-12 | [Full-Text Search Debian package](https://packages.microsoft.com/ubuntu/20.04/mssql-server-2019/pool/main/m/mssql-server-fts/mssql-server-fts_15.0.4470.1-12_amd64.deb) |
| Ubuntu 20.04 | High Availability | 15.0.4470.1-12 | [High Availability Debian package](https://packages.microsoft.com/ubuntu/20.04/mssql-server-2019/pool/main/m/mssql-server-ha/mssql-server-ha_15.0.4470.1-12_amd64.deb) |
| Ubuntu 20.04 | Java Extensibility | 15.0.4470.1-12 | [Java Extensibility Debian package](https://packages.microsoft.com/ubuntu/20.04/mssql-server-2019/pool/main/m/mssql-server-extensibility-java/mssql-server-extensibility-java_15.0.4470.1-12_amd64.deb) |
| Ubuntu 20.04 | PolyBase | 15.0.4470.1-12 | [PolyBase Debian package](https://packages.microsoft.com/ubuntu/20.04/mssql-server-2019/pool/main/m/mssql-server-polybase/mssql-server-polybase_15.0.4470.1-12_amd64.deb) |
...
| --- | --- | --- |
| [CU 32 GDR (May 2026)](/troubleshoot/sql/releases/linux/release-history-2019#15-0-4470) | 15.0.4470.1 | 2026-05-12 |
| [CU 32 GDR (Apr 2026)](/troubleshoot/sql/releases/linux/release-history-2019#15-0-4465) | 15.0.4465.1 | 2026-04-14 |
| [CU 32 GDR (Mar 2026)](/troubleshoot/sql/releases/linux/release-history-2019#15-0-4460) | 15.0.4460.4 | 2026-03-10 |
