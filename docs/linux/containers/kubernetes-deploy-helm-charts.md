...
:::image type="content" source="media/kubernetes-deploy-helm-charts/expand-object-explorer.png" alt-text="Screenshot showing the Object Explorer connected to the database instance.":::
...
- [Quickstart: Deploy SQL Server on Linux using an Ansible playbook](../install-upgrade/deploy-ansible.md)
