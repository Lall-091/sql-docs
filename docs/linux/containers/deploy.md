...
- Get started with [!INCLUDE [sssql19-md](../../includes/sssql19-md.md)] container images on Docker by going through the [quickstart](../install-upgrade/quickstart-install-docker.md)
