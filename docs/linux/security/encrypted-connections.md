...
- **[!INCLUDE [ssmanstudiofull-md](../../includes/ssmanstudiofull-md.md)]**
  ...
  :::image type="content" source="media/encrypted-connections/ssms-encrypt-connection.png" alt-text="Screenshot of SQL Server Management Studio connection dialog.":::
