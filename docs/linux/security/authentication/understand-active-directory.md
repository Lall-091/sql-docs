...
:::image type="content" source="media/understand-active-directory/tgt-spn.png" alt-text="Diagram showing Active Directory authentication for SQL Server on Linux - Ticket-Granting Ticket and Service Principal Name sent to Domain Controller." lightbox="media/understand-active-directory/tgt-spn.svg":::
...
:::image type="content" source="media/understand-active-directory/session-key-received.png" alt-text="Diagram showing Active Directory authentication for SQL Server on Linux - session key returned to client by DC." lightbox="media/understand-active-directory/session-key-received.svg":::

- The encrypted blob from the session key is sent to the server.

:::image type="content" source="media/understand-active-directory/session-key-sent.png" alt-text="Diagram showing Active Directory authentication for SQL Server on Linux - session key sent to server." lightbox="media/understand-active-directory/session-key-sent.svg":::
...
:::image type="content" source="media/understand-active-directory/approved-or-denied.png" alt-text="Diagram showing Active Directory authentication for SQL Server on Linux - connection accepted or denied." lightbox="media/understand-active-directory/approved-or-denied.svg":::
...
:::image type="content" source="media/understand-active-directory/container.png" alt-text="Diagram showing Active Directory authentication for SQL Server Containers." lightbox="media/understand-active-directory/container.svg":::
