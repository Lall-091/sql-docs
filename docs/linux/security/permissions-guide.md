...
For more information on how to change user data location, log file location, or system database and log locations, see [Configure SQL Server on Linux with the mssql-conf tool](../configure/mssql-conf.md).
