...
```  
 ...
 For more information about parameters, prepared statements, and procedures, see [Executing a Statement](../../../odbc/reference/develop-app/executing-a-statement.md).
