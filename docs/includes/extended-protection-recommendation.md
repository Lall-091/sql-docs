...
When you use [Extended Protection](../database-engine/configure-windows/connect-to-the-database-engine-using-extended-protection.md), set **Extended Protection** to **Required** and **Force Encryption** to **Yes** in SQL Server Configuration Manager.

In [!INCLUDE [sssql22-md](../includes/sssql22-md.md)] and later versions, use **Force Strict Encryption** instead of **Force Encryption** to enable stronger security via TDS 8.0. These settings provide the most secure configuration.
