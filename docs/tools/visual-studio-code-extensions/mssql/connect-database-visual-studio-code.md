...
- **Access to a database**: If you don't have access to a database instance, you can use one by selecting one of the following options:
  ...
  - **SQL database in Fabric**: If you need an autonomous, and secure, and optimized for AI database, create a SQL database in Fabric. For more information, see [Create a SQL database in Microsoft Fabric](/fabric/database/sql/tutorial-create-database).
