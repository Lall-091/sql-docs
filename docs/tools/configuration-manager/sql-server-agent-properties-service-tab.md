...
This service is the [!INCLUDE [ssnoversion-md](../../includes/ssnoversion-md.md)] Agent service. This service must be running for [!INCLUDE [ssNoVersion](../../includes/ssnoversion-md.md)] Agent to work properly. The property values in light gray can't be changed by using this application.
...
Displays the name of the computer or cluster running the [!INCLUDE [ssNoVersion](../../includes/ssnoversion-md.md)] Agent service.
