...
This service is the [!INCLUDE [ssnoversion-md](../../includes/ssnoversion-md.md)] [!INCLUDE [ssisnoversion-md](../../includes/ssisnoversion-md.md)] ([!INCLUDE [ssis-md](../../includes/ssis-md.md)]) service. This service must be running for [!INCLUDE [ssis-md](../../includes/ssis-md.md)] to work properly. The property values in light gray can't be changed by using this application.
...
Displays the name of the computer or cluster running the [!INCLUDE [ssis-md](../../includes/ssis-md.md)] service.
