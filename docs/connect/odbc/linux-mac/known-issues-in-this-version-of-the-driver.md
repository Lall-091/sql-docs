...
The error can happen when OpenSSL 3.0 is installed. OpenSSL typically is installed through **Homebrew**, and it contains the `openssl`, `openssl@1.1`, and `openssl@3` binaries.
