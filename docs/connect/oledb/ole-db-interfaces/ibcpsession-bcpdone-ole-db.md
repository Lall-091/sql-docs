---
title: "IBCPSession::BCPDone (OLE DB driver)"
...
## Remarks  
 No other operation can be called on the [IBCPSession](../../oledb/ole-db-interfaces/ibcpsession-ole-db.md) interface after calling the **BCPDone** method. The only possibility is to call the [IBCPSession::BCPInit](../../oledb/ole-db-interfaces/ibcpsession-bcpinit-ole-db.md) method to initiate a new bulk copy operation. This is similar to calling the [IRowsetFastLoad::Commit](../../oledb/ole-db-interfaces/irowsetfastload-commit-ole-db.md) method.  
