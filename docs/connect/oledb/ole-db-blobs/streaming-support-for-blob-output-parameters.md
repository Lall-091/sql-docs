...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
 ...
 You can become blocked on output parameters in IMultipleResults::GetResult, receiving DB_E_OBJECTOPEN return value. The caller should check for pending blob parameters, and either read them completely or release them.  
