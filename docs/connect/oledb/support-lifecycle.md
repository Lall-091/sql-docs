...
The Microsoft OLE DB Driver for SQL Server follows the [Modern Lifecycle Policy](https://support.microsoft.com/help/30881/modern-lifecycle-policy) with a few additions. This policy ensures that customers receive continuous support and updates, including security fixes and new features.
...
Customers are encouraged to install the latest version of the Microsoft OLE DB Driver for SQL Server to ensure they have the latest fixes and security updates.
...
|----------------|------------------------|----------------------|
| OLE DB Driver 19 for SQL Server | January 11, 2028<sup>1</sup> | Not applicable |
