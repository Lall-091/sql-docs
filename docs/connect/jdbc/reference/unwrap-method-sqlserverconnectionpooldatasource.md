...
## Remarks  
 The [unwrap](#unwrap-method-sqlserverconnectionpooldatasource) method is defined by the java.sql.Wrapper interface, which is introduced in the JDBC 4.0 Spec.  
