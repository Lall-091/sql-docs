...
ms.author: dlevy
ms.reviewer: mikeray, davidengel, machavan, sunilbs
ms.date: 03/21/2021
ms.service: sql
...
|`fipsProvider`|String|null|FIPS provider configured in JVM. For example, BCFIPS or SunPKCS11-NSS |Added in 6.1.2 (Stable release 6.2.2), deprecated in 6.4.0. For more information, see [Removing connection property - fipsProvider](https://github.com/Microsoft/mssql-jdbc/pull/460).|
