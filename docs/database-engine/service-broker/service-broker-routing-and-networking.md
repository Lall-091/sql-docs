...
| Article | Description |
| --- | --- |
| [Service Broker routing](service-broker-routing.md) | Describes how Service Broker routes messages. |
| [Service Broker communication protocols](service-broker-communication-protocols.md) | Describes how Service Broker uses a broker-specific protocol to communicate with remote brokers. |
| [Service Broker message forwarding](service-broker-message-forwarding.md) | Describes the message forwarding system. |
