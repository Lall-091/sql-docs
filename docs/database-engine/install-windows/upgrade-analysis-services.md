...
- [Compatibility level of a multidimensional database (Analysis Services)](/analysis-services/multidimensional-models/compatibility-level-of-a-multidimensional-database-analysis-services)
- [Compatibility level for Analysis Services tabular models](/analysis-services/tabular-models/compatibility-level-for-tabular-models-in-analysis-services)
