...
On the **Azure Extension for SQL Server** page, you can configure [!INCLUDE [ssNoVersion](../../includes/ssnoversion-md.md)] to connect to Azure. [!INCLUDE [ssnoversion-md](../../includes/ssnoversion-md.md)] enable using Azure services such as Microsoft Defender for Cloud, Microsoft Purview, Microsoft Entra ID, and others. This feature is selected by default. If you wish to proceed without connecting to Azure, you can unselect **Azure Extension for SQL Server**.
