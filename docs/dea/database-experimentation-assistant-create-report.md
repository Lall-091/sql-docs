...
1. In DEA, select the list icon, specify the server name and authentication type, select or deselect the **Encrypt connection** and **Trust server certificate** check boxes as appropriate for your scenario, and then select **Connect**.
   ...
   :::image type="content" source="media/database-experimentation-assistant-create-report/dea-connect-to-server-with-trace-files.png" alt-text="Screenshot of Connect to server with trace files." lightbox="media/database-experimentation-assistant-create-report/dea-connect-to-server-with-trace-files.png":::

1. On the **Analysis Reports** screen, select **New analysis report**.

   :::image type="content" source="media/database-experimentation-assistant-create-report/dea-create-an-analysis-report.png" alt-text="Screenshot of Create new analysis report." lightbox="media/database-experimentation-assistant-create-report/dea-create-an-analysis-report.png":::

1. On the **New analysis report** screen, specify a name for the report, the storage location and path to the Target 1 and Target 2 trace files, and then select **Start**.

   :::image type="content" source="media/database-experimentation-assistant-create-report/dea-new-analysis-report-details.png" alt-text="Screenshot of Specify new analysis report details." lightbox="media/database-experimentation-assistant-create-report/dea-new-analysis-report-details.png":::
...
DEA uses statistical tests to analyze your workload and determine how each query ran from Target 1 to Target 2. It provides performance details for each query. Learn more about DEA in [Overview of the workload comparison process](database-experimentation-assistant-get-started.md).
...
Yes. You can generate an analysis report at the command prompt. You can then view the report in the UI. For more information, see [Run Database Experimentation Assistant at a command prompt](database-experimentation-assistant-run-command-prompt.md).
...
- [View analysis reports in Database Experimentation Assistant](database-experimentation-assistant-view-report.md)
