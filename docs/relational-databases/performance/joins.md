...
For more information about hash bailout, see [Hash Warning Event Class](../event-classes/hash-warning-event-class.md).
...
The query returns 336 rows. Enabling [Live Query Statistics](live-query-statistics.md) displays the following plan:
...
- [Subqueries (SQL Server)](subqueries.md)
- [Adaptive Joins](intelligent-query-processing-details.md#batch-mode-adaptive-joins)
