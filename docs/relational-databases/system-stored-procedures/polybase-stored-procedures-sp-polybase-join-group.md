...
The SQL Server instance must have the [PolyBase](../polybase/overview.md) feature installed. PolyBase enables the integration of non-SQL Server data sources, such as Hadoop and Azure Blob Storage. See also [sp_polybase_leave_group](polybase-stored-procedures-sp-polybase-leave-group.md).
