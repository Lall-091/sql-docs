---
title: "sys.sp_MSchange_snapshot_agent_properties (Transact-SQL)"
...
dev_langs:
  - "TSQL"
---
# sys.sp_MSchange_snapshot_agent_properties (Transact-SQL)
...
The login for the Windows account under which the agent runs. *@job_login* is **nvarchar(257)**, with no default. This Windows account is always used for agent connections to the Distributor. You must supply this parameter when creating a new Snapshot Agent job.
