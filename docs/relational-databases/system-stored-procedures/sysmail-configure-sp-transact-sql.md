...
You can also grant `EXECUTE` permissions for any user, which allows the user to use this procedure to read the configuration, but not to change any parameters. These added permissions might be overridden during a SQL Server upgrade.
