---
title: "sys.sp_unregistercustomresolver (Transact-SQL)"
...
dev_langs:
  - "TSQL"
---
# sys.sp_unregistercustomresolver (Transact-SQL)
...
```syntaxsql
sys.sp_unregistercustomresolver [ @article_resolver = ] N'article_resolver'
[ ; ]
```
