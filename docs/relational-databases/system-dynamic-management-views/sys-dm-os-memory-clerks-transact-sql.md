...
|CACHESTORE_TEMPTABLES     |     This cache store is used for allocations related to [temporary tables and table variables caching](../databases/tempdb-database.md#improvements-in-tempdb-for-sql-server) - part of plan cache.    |
...
|MEMORYCLERK_POLYBASE     |    This memory clerk keeps track of memory allocations for [PolyBase](../polybase/overview.md) functionality inside SQL Server.     |
...
|MEMORYCLERK_SVL     |    This memory clerk is used for allocations of internal SQL OS structures |
