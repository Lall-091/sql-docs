...
| 9042 | 16 | No | Invalid configuration to transform the log file to Hyperscale format. |
...
| 9050 | 16 | No | Invalid request to transform the log file to Hyperscale format. |
| 9051 | 10 | No | The LSN %S_LSN passed to log dumper in database '%.\*ls' is not valid. |
| 9052 | 17 | No | The database '%.\*ls' is in a state that does not allow new log to be generated until a new VLF can be created. Please release the active log by cancelling long running transactions. |
| 9053 | 17 | No | The transaction log for database '%.\*ls' is full due to the database being on a higher service level objective (SLO) than one of its geo-secondary databases. Please update the SLO of all geo-secondary databases to match the SLO of current database. |
| 9054 | 16 | No | Invalid request to move the first VLF while transforming the log file to Hyperscale format. |
...
| 9130 | 10 | No | Warning: Ignoring update of '%.\*ls' statistics. ACE statistics are auto updated, UPDATE STATISTICS DDL statement is not supported. |
| 9131 | 16 | No | Stats messages cannot be sent because the feature was disabled during SQL startup. |
| 9132 | 16 | No | Stat messages cannot be sent because the stats manager is still starting. |
| 9133 | 16 | No | Stat messages could not be processed, because the database does not exist or could not be opened. |
| 9134 | 16 | No | Stat messages could not be processed, because the message version is not understood by the server. |
| 9135 | 16 | No | Stat messages could not be processed, because the message failed to parse. |
| 9136 | 17 | No | Stat messages could not be processed, because the table or index has been dropped or modified. |
| 9137 | 16 | No | The statement failed because the necessary statistics could not be automatically created for '%.\*ls' due to a change in the table schema since the snapshot transaction started. Retry executing the statement. |
| 9138 | 17 | No | Stat were updated recenty, skipping another update. |
| 9139 | 17 | No | Statistics are too large to be sent to the primary. |
| 9140 | 17 | No | The existing statistics and the incoming update have different INCREMENTAL settings, discarding the update. |
| 9141 | 17 | No | There was an error updating the statistic. Please contact customer support. |
...
| 9841 | 16 | No | An invalid Unicode escape sequence was specified in the input. Unicode escape sequences should be specified as \<UESCAPE character\>XXXX or \<UESCAPE character\>+XXXXXX where X is a \<hexit\>. |
...
| 9992 | 16 | No | Failed to retrieve full-text drop batch size configuration. A drop batch size of %d will be used instead. |
| 9993 | 10 | No | Informational: Failed to create Fulltext index internal table to track failed DocId on table '%.\*ls'. |
| 9994 | 10 | No | Informational: Failed to insert failed Doc Id '%d' from table '%ls' into the internal table, error: %d. |
| 9995 | 16 | No | Internal table access error: failed to access the Fulltext failed DocId internal table with HRESULT: 0x%x. |
| 9996 | 10 | No | Failed to create DML AFTER trigger to track DML operations on failed Doc Id for table '%ls'. |
