...
| 11573 | 16 | No | The value of the %.\*ls parameter should be in the range %.\*ls. |
...
| 11747 | 16 | No | Value of parameter '%.\*ls' is out of expected range. |
...
| 11805 | 16 | No | Operation was aborted because LastBackupName parameter contains forbidden characters ('\n' or '\r'). |
| 11806 | 16 | No | The operation was aborted because the 'LastBackupName' parameter contains invalid characters. Only ASCII characters are allowed. |
...
| 11907 | 10 | No | The operation cannot be completed because a connection to the native shuffle storage could not be made. Please try to run the operation again. If the error persists, please contact support. |
...
| 12463 | 11 | No | Role id should be between (including) 1 and 4 |
...
| 12506 | 16 | No | The distribution option used is not supported in the CREATE TABLE query. |
| 12507 | 16 | No | The index option selected is not supported in a CREATE TABLE AS SELECT query. |
| 12508 | 16 | No | Cross-database table clone is not supported. |
| 12509 | 14 | No | The user either lacks required permissions on the source or target database, schema, or table, otherwise one or more does not exist. |
| 12510 | 16 | No | Feature '%.\*ls' is not supported by table clone. |
| 12511 | 16 | No | Database Clone is not enabled for this instance. |
| 12512 | 16 | No | Internal error. Encounter unexpected error while cloning trident dw database. |
| 12513 | 18 | No | An internal error occurred while cloning the specified table. |
| 12514 | 16 | No | The specified point-in-time is invalid. The timestamp must not be after the current system time. |
| 12515 | 16 | No | The specified point-in-time is invalid. The timestamp must not be before the object was created. |
| 12516 | 16 | No | The specified point-in-time is invalid. The timestamp must not be before the object was last altered. |
| 12517 | 16 | No | The specified point-in-time is outside of the data retention period for the table. The retention period defined for this table is %d days. |
| 12518 | 16 | No | The specified point-in-time is invalid. The point-in-time must be before the current transaction's begin time. |
| 12519 | 16 | No | The FOR TIMESTAMP AS OF query hint can only be specified once per statement. |
| 12520 | 16 | No | A non-versionable data source was specified in the time travel query. |
| 12521 | 16 | No | The FOR TIMESTAMP AS OF query hint can only be used with read-only SELECT statements. |
| 12522 | 16 | No | The specified point-in-time is outside of the data retention period for the database. The retention period defined for this database is %d days. |
...
| 12713 | 16 | No | OPENROWSET is not allowed to read local files. Path: '%ls'. |
