...
| 8583 | 10 | Yes | DTC fully qualified domain name (FQDN) resolution setting is '%ls'. |
...
| 8639 | 16 | No | The query processor could not produce a query plan because in current warehousing design, this system function parameter can only take data input from system objects." |
...
| [8649](../mssqlserver-8649-database-engine-error.md) | 16 | No | The query has been canceled because the estimated cost of this query (%d) exceeds the configured threshold of %d. Contact the system administrator. |
...
| 8737 | 17 | No | Error 0x%X occurred when sending data over the network to another distribution. Additional details: '%s'. Please try to run the query again. If the error persists, please contact support. |
| 8738 | 17 | No | Error 0x%X occurred when opening a connection from distribution %d to distribution %d. Additional details: '%s'. Please try to run the query again. If the error persists, please contact support. |
| 8739 | 17 | No | Error occurred when sending metadata over the network from distribution %d to distribution %d. Additional details: '%s'. Please try to run the query again. If the error persists, please contact support. |
...
| 8760 | 16 | No | Recompile with replay script for long haul testing for Optimization Replay feature |
| 8761 | 16 | No | Unsupported virtual column in memo XML. |
| 8762 | 16 | No | Table-valued function '%s' is not supported in this version of Synapse Sql. |
| 8763 | 16 | No | TABLESAMPLE with 'ROWS' clause is unsupported in this version of Synapse SQL. |
| 8764 | 17 | No | Error occurred when sending metadata over the network from distribution %d to distribution %d. Additional details: '%s'. Please try to run the query again. If the error persists, please contact support. |
| 8765 | 17 | No | Error 0x%X occurred when %S_MSG a connection from distribution %d to distribution %d. Additional details: '%s'. Please try to run the query again. If the error persists, please contact support. |
| 8766 | 17 | No | An error occurred when reading data moved from one distribution to another. Try to run the query again. If the error persists, contact support. |
| 8767 | 17 | No | Error occurred when reading metadata from distribution %d. Additional details: '%s'. Please try to run the query again. If the error persists, please contact support. |
| 8768 | 16 | No | Recursive CTEs are unsupported in this version of Synapse SQL. |
| 8769 | 10 | No | Warning: The estimated result set size for this query is %I64u. Consider adding filters to reduce the result size or sending result to a file or external table. |
| 8770 | 10 | No | Unsupported expression in Memo XML. |
| 8771 | 10 | No | Unsupported operator for resource actuals feedback. |
| 8772 | 10 | No | Recompile for Trident Result Set Cache creation |
| 8773 | 10 | No | Reserved error message. Should never be issued. |
| 8774 | 10 | No | %s |
| 8775 | 10 | No | %s |
| 8776 | 10 | No | %s |
| 8777 | 10 | No | %s |
| 8778 | 16 | No | Query execution has been aborted because the ABORT_QUERY_EXECUTION hint was specified. |
| 8779 | 17 | No | Failed to initialize in-memory storage for operator metrics feedback. |
| 8780 | 16 | No | Schema mismatch during native data movement. If this error persists, contact support. |
| 8781 | 16 | No | Query processor could not produce a query plan because of the error in reusing multiconsumer spool in the plan. |
| 8782 | 16 | No | Memo deserialization has been completed successfully. |
| 8783 | 16 | No | Table metadata could not be found. |
| 8784 | 16 | No | Unsupported operator in Memo XML. |
| 8785 | 16 | No | NCCI in broadcast mode unsupported error |
| 8786 | 16 | No | Query processor could not force query provided in USE PLAN hint because it couldn't generate an index seek close enough to the specified in the showplan XML. |
| 8787 | 16 | No | Updating the row count of a distributed table is not allowed in this version. |
| 8788 | 16 | No | REPLICATE_LEFT hint not allowed in this version. |
| 8789 | 10 | No | %s Nested CTE internal diagnostic message |
| 8790 | 10 | No | One or more non-scalable operation is detected. Check product documentation for details. |
| 8791 | 10 | No | %s |
| 8792 | 16 | No | Query processor could not produce query plan because the USE HINT option contains invalid hint. Remove or replace USE HINT: %s. |
| 8800 | 16 | No | \[DOP Feedback\] Internal error has occurred for: plan hash: %I64x, plan id: %d. |
| 8801 | 10 | No | Warning: The FORCE DISTRIBUTED PLAN query hint was applied, but the query was executed using a single node plan. Check product documentation for details. |
