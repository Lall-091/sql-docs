...
| 2573 | 16 | No | Could not find table or object ID %ld. Check system catalog. |
...
| 2578 | 16 | No | Json corruption found in column "%.\*ls" in table '%ls' (ID %d). Data row (%d:%d:%d) identified by (%ls) is corrupted. Please update the column with a valid Json. |
