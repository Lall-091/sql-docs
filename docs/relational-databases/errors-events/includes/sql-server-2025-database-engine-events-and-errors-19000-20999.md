...
| 19300 | 16 | No | An invalid Pattern '%.\*s' was provided. Error '%.\*s' occurred during evaluation of the Pattern. |
| 19301 | 16 | No | '%.\*ls' value should be greater than or equal to %d but '%d' is provided in '%.\*ls' function. |
| 19302 | 16 | No | Maximum of '%d' flags can be provided. But you provided '%d' flags. |
| 19303 | 16 | No | Invalid flag provided. '%.\*s' are not valid flags. Only {c,i,s,m} flags are valid. |
| 19304 | 16 | No | Currently, '%.\*s' function does not support NVARCHAR(max)/VARCHAR(max) inputs. |
| 19305 | 16 | No | Failed to replace '%.\*ls' with replacement string '%.\*ls' from start position '%d'. |
| 19306 | 16 | No | The provided Pattern is too complex. Please retry by reducing the complexity of Pattern - '%.\*ls'. |
| 19307 | 16 | No | Encountered an unexpected '%.\*ls' in the Pattern %.\*s. |
| 19308 | 16 | No | Missing '%.\*ls' in the Pattern %.\*s. |
| 19309 | 16 | No | Invalid trailing backslash (\) provided at the end of the Pattern %.\*s. |
| 19310 | 16 | No | The supplied 'string_expression' value to '%.\*ls' function exceeds the supported max length for regex operation. |
| 19311 | 16 | No | The input for 'string_expression' exceeds the maximum allowed size of 2MB. Please ensure the input size is within the allowed limit and try again. |
| 19312 | 16 | No | The query failed due to an unexpected error while compiling the regex pattern in the %.\*ls function. Please retry and contact support if the error persists. |
...
| 19531 | 16 | No | Database \[%ls\] failed to refresh lease info with fabric, request returned with \[%ld\]. Check the SQL Server error log on the exact failure. |
| 19532 | 16 | No | While reverting to the common recovery point, database "%.\*ls" retrieved a page that may not be consistent with existing pages or log records. To gain access to the database, you need to determine what has changed in the session configuration and undo the change. |
...
| 19705 | 17 | No | Failed to create a new database due to system error. |
...
| 19715 | 16 | No | Resolving schema for Delta Lake table '%ls' failed with error: Unable to read schema from Delta logs. |
| 19716 | 16 | No | Data path was not properly set or is missing in the DDL statement. |
| 19717 | 16 | No | SP '%.\*ls' should be called under the explicitly started transaction (started with BEGIN TRAN). |
| 19718 | 10 | No | Resolving Delta logs on path '%ls' warning: Partitioning column '%.\*ls' not found in inferred or provided schema. |
| 19719 | 17 | No | Failed to acquire mutex for DW DB attachment with result %lu. |
| 19720 | 10 | No | Filter pushdown not supported for column type-filter param type pair. |
| 19721 | 17 | No | DW database attachment task failed for database with ID %d (HRESULT = 0x%x). |
| 19722 | 17 | No | DW database attachment task failed to notify MS upon its completion (HRESULT = 0x%x). |
| 19723 | 17 | No | Database attachment failed because another database with ID %ld already exists. |
| 19724 | 17 | No | Database could not be successfully attached to appropriate DB ID. |
| 19725 | 16 | No | Column mapping is not enabled. |
| 19726 | 16 | No | Feature '%ls' is not supported for table '%ls'. |
| 19727 | 16 | No | Resolving schema for Delta Lake table '%ls' failed with error: Empty column name found in Delta logs. |
| 19728 | 17 | No | Database could not be successfully detached. |
| 19729 | 17 | No | Database(s) could not be successfully attached. |
| 19730 | 17 | No | Database state could not be successfully fetched. |
| 19731 | 16 | No | Failed calculating cardinality for '%.\*ls'. |
| 19732 | 14 | Yes | Login failed for user '%.\*ls' due to no proper resource access. Only backend connections are allowed.%.\*ls |
| 19733 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19734 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19735 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19736 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19737 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19738 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19739 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19740 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19741 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19742 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19743 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19744 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19745 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19746 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19747 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19748 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19749 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19750 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19751 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19752 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19753 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19754 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19755 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19756 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19757 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19758 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19759 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19760 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19761 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19762 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19763 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19764 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19765 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19766 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19767 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19768 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19769 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19770 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19771 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19772 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19773 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19774 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19775 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19776 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19777 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19778 | 16 | No | Error encountered while parsing data: '%ls'. It might happen for one of the various reasons: \n1. Parquet file is corrupted. \n2. The file size defined in the metadata is smaller than the actual size of the file. \n3. Wrong file type ingested. \n4. The file changed during the query execution. \nUnderlying data description: %ls. |
| 19779 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19780 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19781 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19782 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19783 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19784 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19785 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19786 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19787 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19788 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19789 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19790 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19791 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19792 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19793 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19794 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19795 | 17 | No | Failed to start database '%ls' for recovery. |
| 19796 | 16 | No | Failed to read parquet file because the column segment for column '%ls' is too large. Underlying data description: '%ls'. |
| 19797 | 16 | No | Operation %ls is not allowed in dbo schema. |
| 19798 | 16 | No | An unexpected system error was reported (%ls, %ls). |
| 19799 | 17 | No | Restore for database failed. |
| 19801 | 17 | No | Lease metadata inconsistency has been detected on blob. |
| 19802 | 16 | No | Partition column '%ls' has unsupported type. |
| 19803 | 14 | Yes | Login failed for user '%.\*ls' because the DMS moniker was not found. Only backend connections are allowed.%.\*ls |
| 19804 | 16 | No | Restore for database "%.\*ls" is in progress. |
| 19805 | 17 | No | Fetching DW database properties failed. |
| 19806 | 16 | No | The provided file format is not supported. Please ensure the file is in one of the supported .ss formats (up to v5). Underlying data description: %ls. |
| 19807 | 16 | No | Error encountered while parsing data: '%ls'. Underlying data description: %ls. |
| 19808 | 16 | No | Error encountered while reading data: '%ls'. Underlying data description: %ls. |
| 19809 | 16 | No | Error encountered while reading data: '%ls'. Underlying data description: %ls. |
| 19810 | 17 | Yes | Login failed for user '%.\*ls' as storage SAS token refresh was delayed or failed. Only backend connections are allowed.%.\*ls |
| 19811 | 16 | No | Maximum LOB value size has been exceeded for column '%ls'. Underlying data description: %ls. |
| 19812 | 16 | No | CODEPAGEs different than 65001 and 1200 are not supported when CSV 2.0 is specified. |
| 19813 | 17 | No | Failed to change lease order id. |
| 19814 | 17 | No | Database could not be successfully detached for deletion. |
| 19815 | 17 | No | Workspace state could not be successfully fetched. |
| 19816 | 16 | No | Complex types not supported for parquet data unit. Underlying data description: %ls. |
| 19817 | 16 | No | DataBlock size is too small. Underlying data description: %ls. |
| 19818 | 16 | No | DataBlock column offset is incorrect. Underlying data description: %ls. |
| 19819 | 16 | No | DataBlock column sizes offset is incorrect. Underlying data description: %ls. |
| 19820 | 16 | No | DataBlock column options are incorrect. Underlying data description: %ls. |
| 19821 | 16 | No | DataBlock size is incorrect. Underlying data description: %ls. |
| 19822 | 16 | No | Decimal rescale failed. Underlying data description: %ls. |
| 19823 | 16 | No | Empty column name found while resolving schema for CosmosDB collection: %ls. |
| 19824 | 16 | No | Error encountered while reading data: '%ls'. Underlying data description: %ls. |
| 19825 | 16 | No | Column count mismatch, the column count in the file doesn't match column count in the table schema when reading row %d. Set the MATCH_COLUMN_COUNT option to OFF if you want to skip this check. Underlying data description: %ls. |
| 19826 | 17 | No | Error encountered while updating One Security mode for database '%ls' under workspace '%ls'. |
| 19827 | 16 | No | Column count mismatch, the column count in the file doesn't match column count in the table schema. Column '%ls' is not present in the table. Set the MATCH_COLUMN_COUNT option to OFF if you want to skip this check. Underlying data description: %ls. |
| 19828 | 16 | No | Column count mismatch, the column count in the file doesn't match column count in the table schema. Column '%ls' is not present in the file. Set the MATCH_COLUMN_COUNT option to OFF if you want to skip this check. Underlying data description: %ls. |
| 19829 | 16 | No | Error encountered while trying to lock a shared object %d. |
| 19830 | 16 | No | Cannot grant, deny, or revoke %.\*ls permission because the warehouse is in user's identity mode for OneLake access. To use these statements, the warehouse or SQL endpoint must be in delegated identity mode. |
| 19831 | 16 | No | Cannot change membership of the fixed database roles because the warehouse is in user's identity mode for OneLake access. To use these statements, the warehouse or SQL endpoint must be in delegated identity mode. |
| 19832 | 17 | No | Error in reading Frontend instance certificate thumbprint. |
| 19833 | 16 | No | Select statements are not allowed in SQL scalar user defined functions. |
| 19834 | 17 | No | Database backup failed. |
| 19835 | 16 | No | Scalar UDF execution is currently unavailable in this context. See [https://go.microsoft.com/fwlink/?linkid=2304777](https://go.microsoft.com/fwlink/?linkid=2304777) for updates. |
