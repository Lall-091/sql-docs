...
| 15048 | 10 | No | Valid values of the database compatibility level are %d, %d, %d, %d, %d, %d, %d or %d. |
...
| 15063 | 16 | No | The login already has an account with the user name '%ls'. |
...
| 15660 | 16 | No | Compressing spatial or hash indexes is not supported by the stored procedure sp_estimate_data_compression_savings. |
...
| 15721 | 16 | No | Could not build Automatic Tuning's internal tables on database (ID %d). |
| 15722 | 16 | No | Internal table access error: failed to access the Automatic Tuning internal table with HRESULT: 0x%x. |
| 15723 | 16 | No | Failed to execute Automatic Tuning's stored procedure for error %d. |
| 15724 | 16 | No | Failed to acquire RW lock for Automatic Tuning Agent scheduling for Error %d. |
| 15725 | 16 | No | Automatic Tuning stored procedure's parameter %ls cannot be null. |
| 15726 | 16 | No | Failed to execute Automatic Tuning's stored procedure for reason: %ls. |
...
| 15811 | 16 | No | No columns found. Underlying data description: %ls. |
| 15812 | 16 | No | The number of columns exceeds the maximum allowed limit %d. Underlying data description: %ls. |
| 15813 | 16 | No | Error handling external file: '%ls'. Underlying data description: %ls. |
| 15814 | 16 | No | Column '%ls' of type '%ls' is not compatible with external data type '%ls'. Underlying data description: %ls. |
| 15815 | 16 | No | External data type '%s' is currently not supported. Underlying data description: %ls. |
...
| 15848 | 16 | No | Cannot complete the sp_set_data_processed_limit stored procedure. Invalid limit value %ld is specified. Values must be between 0 and 2147483646. |
