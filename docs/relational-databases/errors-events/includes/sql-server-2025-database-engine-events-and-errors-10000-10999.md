...
| 10682 | 16 | No | Cannot convert the %S_MSG '%.\*ls' to a relational index by using the DROP_EXISTING option. |
| 10683 | 16 | No | Cannot create %S_MSG because %S_MSG already exists on the table. |
