...
| 16506 | 16 | No | The column name starting with '%.\*ls' is too long. The maximum length is %d characters. Underlying data description: %ls. |
| 16507 | 16 | No | String or binary data would be truncated while reading column of type '%ls'. Check ANSI_WARNINGS option. Underlying data description: %ls, column '%ls'. Truncated value: '%ls'. |
| 16508 | 16 | No | Error converting values NaN or Infinity to type '%ls'. NaN and Infinity are not supported. Underlying data description: %ls, column '%ls', value '%ls'. Check ANSI_WARNINGS and ARITHABORT options. |
| 16509 | 16 | No | Arithmetic overflow error converting '%ls' to data type '%ls'. Underlying data description: %ls, column '%ls', value '%ls'. Check ANSI_WARNINGS, ARITHABORT and NUMERIC_ROUNDABORT options. |
...
| 16529 | 16 | No | IO operation failed during processing '%ls' with error: '%ls'. Underlying data description: %ls. |
| 16530 | 16 | No | IO operation failed with error: '%ls'. Underlying data description: %ls. |
| 16531 | 16 | No | Budget %ls limit cannot be set to %lu. Condition that must be satisfied: daily limit \<= weekly limit \<= monthly limit. |
...
| 16535 | 16 | No | Cannot process the file "%ls" because it does not exist or you don't have file access rights. |
| 16536 | 16 | No | Cannot process the file "%ls" because it could not be opened. |
...
| 16560 | 16 | No | Column '%ls' of type '%ls' is not compatible with external data type '%ls', please try with '%ls'. Underlying data description: %ls. |
...
| 16575 | 16 | No | Arithmetic overflow error converting a value to data type '%ls'. Underlying data description: %ls, column '%ls'. Please try with '%ls'. |
...
| [16594](../mssqlserver-16594-database-engine-error.md) | 16 | No | Bulk load data conversion error (NULL in non-nullable column);%I64d;%d;%ls;%ls;%d;%ls. |
...
| 16600 | 16 | No | Invalid or unknown dateformat '%.\*ls'. |
...
| 16655 | 16 | No | Cannot add column '%ls' from table '%ls' to schema because the data type of this column is '%ls'. |
| 16656 | 16 | No | Please specify only one user managed identity per sync group or member. |
...
| 16723 | 16 | No | An error has occurred while enabling Long-term backup retention for this database. Please reach out to Microsoft support to enable long-term backup retention. |
| 16724 | 16 | No | The long-term retention backup with the desired storage access tier already exists. |
| 16725 | 16 | No | Restoring archived long-term retention backup is not supported. Restore can be performed only on rehydrated or regular long-term retention backups. |
| 16726 | 16 | No | Archiving long-term retention backups on zone redundant backup storage is not supported. Use locally redundant or geo-redundant storage types instead. |
| 16727 | 16 | No | Archiving long-term retention backups is not enabled. |
| 16728 | 16 | No | Archiving long-term retention backups on Hyperscale databases is not enabled. |
| 16729 | 16 | No | ChangeLongTermRetentionBackupAccessTier is not supported for the desired (%ls, %ls) combination. Only (Archive, Move) and (Hot, Copy) are allowed. |
| 16730 | 16 | No | Setting a long-term retention policy with the backup storage access tier set to 'archive' is not supported on zone-redundant backup storage. Use either locally redundant or geo-redundant storage types. |
| 16731 | 16 | No | Updating the backup storage redundancy type to zone-redundant storage is not supported when a long-term retention policy with the 'archive' backup storage access tier is set at the %ls level. |
| 16732 | 16 | No | The subscription ID is required to update the long-term retention backup. |
| 16733 | 16 | No | The server name is required to update the long-term retention backup. |
| 16734 | 16 | No | The database name is required to update the long-term retention backup. |
| 16735 | 16 | No | The provided long-term retention backup resource ID or backup name is incorrect. |
