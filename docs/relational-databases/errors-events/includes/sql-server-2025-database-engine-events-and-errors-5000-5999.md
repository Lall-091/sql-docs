...
| 5125 | 24 | No | File '%ls', File ID '%d' was found to be shorter than expected during %ls. Expected size is %I64d KB but actual size is %I64d KB. Examine the disk system for potential failures. |
...
| 5375 | 16 | No | Cannot access internal expression index column '%.\*ls'. |
| 5376 | 16 | No | Cannot modify permissions for Index on Expression column '%.\*s'. |
| 5377 | 16 | No | Cannot alter column '%.\*s' because it is index on expression column. |
| 5378 | 16 | No | Adding constraint to Index On Expression column '%.\*s' is not allowed. |
| 5379 | 16 | No | Column ordinal value is not allowed in the column definition for the column '%ls' and file format '%ls'. |
...
| 5875 | 16 | No | Cannot configure tiered memory for this edition of SQL Server. |
| 5876 | 16 | No | Tiered Memory is not supported on this platform or in this edition of SQL Server. |
