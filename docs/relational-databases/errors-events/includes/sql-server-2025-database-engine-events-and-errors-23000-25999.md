...
| 23656 | 16 | No | Enabling Change Streams for %s table '%s' is not supported. |
...
| 23675 | 16 | No | Enabling Change Streams for table '%s' that has a column set column is not supported. |
