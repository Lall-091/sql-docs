...
In [!INCLUDE [sssql16-md](../../includes/sssql16-md.md)] and later versions, there are multiple concurrent threads responsible to persist changes to memory-optimized tables.

## Multi-threaded recovery

In the previous release of [!INCLUDE [ssNoVersion](../../includes/ssnoversion-md.md)], the log apply portion of the recovery operation was single threaded. In [!INCLUDE [sssql16-md](../../includes/sssql16-md.md)] and later versions, the log apply is multithreaded.
