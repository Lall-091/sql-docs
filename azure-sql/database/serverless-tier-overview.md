...
[Azure Hybrid Benefit (AHB)](../azure-hybrid-benefit.md) and [Azure Reservations discounts](reservations-discount-overview.md) do not apply to the serverless compute tier.
