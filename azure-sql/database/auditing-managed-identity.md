...
1. Select **Review + assign**.
   ...
   :::image type="content" source="media/auditing-managed-identity/auditing-role-assignment-for-identity.png" alt-text="Screenshot of assigning the Storage Blob Data Contributor to the Managed Identity in the Azure portal." lightbox="media/auditing-managed-identity/auditing-role-assignment-for-identity.png":::
...
1. You can then select the added managed identity as the **Primary identity** for your server.
   ...
   :::image type="content" source="media/auditing-managed-identity/auditing-select-primary-identity.png" alt-text="Screenshot of the Identity menu in the Azure portal and selecting the primary identity." lightbox="media/auditing-managed-identity/auditing-select-primary-identity.png":::
