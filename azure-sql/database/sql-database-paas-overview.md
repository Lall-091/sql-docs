...
- The [General Purpose](service-tiers-sql-database-vcore.md#general-purpose) service tier is designed for common workloads. It offers budget-oriented balanced compute and storage options.
