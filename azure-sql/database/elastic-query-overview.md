...
Execute remote stored procedure calls or remote functions using [sp_execute _remote](/sql/relational-databases/system-stored-procedures/sp-execute-remote-azure-sql-database).
...
:::image type="content" source="media/elastic-query-overview/overview.png" alt-text="Screenshot of Elastic query used on scaled-out data tier." lightbox="media/elastic-query-overview/overview.png":::
...
:::image type="content" source="media/elastic-query-overview/vertpartrrefdata.png" alt-text="Screenshot of Vertical partitioning - Using elastic query to query reference data." lightbox="media/elastic-query-overview/vertpartrrefdata.png":::
...
:::image type="content" source="media/elastic-query-overview/verticalpartitioning.png" alt-text="Screenshot of Vertical partitioning - Using elastic query to query across various databases.":::
...
- [CREATE EXTERNAL DATA SOURCE](/sql/t-sql/statements/create-external-data-source-transact-sql) `mydatasource` of type `RDBMS`
...
:::image type="content" source="media/elastic-query-overview/horizontalpartitioning.png" alt-text="Screenshot of Horizontal partitioning - Using elastic query for reporting over sharded data tiers." lightbox="media/elastic-query-overview/horizontalpartitioning.png":::
...
- [CREATE EXTERNAL DATA SOURCE](/sql/t-sql/statements/create-external-data-source-transact-sql) `mydatasource` of type `SHARD_MAP_MANAGER`.
