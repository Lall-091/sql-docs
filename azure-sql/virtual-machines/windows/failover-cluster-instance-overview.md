...
> [!NOTE]  
> While Azure shared disks also support [Standard SSD sizes](/azure/virtual-machines/disks-shared#disk-sizes), we don't recommend using Standard SSDs for SQL Server workloads due to the performance limitations.
