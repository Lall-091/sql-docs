...
<a id="blobssms"></a>
 ...
 - **Configure blob storage for audit logs, using SQL Server Management Studio 18 and later versions:**
     ...
     1. Expand the **Security** node, right-click on the **Audits** node, and select **New Audit**:
        ...
        :::image type="content" source="media/auditing-configure/10-new-audit.png" alt-text="Screenshot showing how to Expand security and audit node.":::

     1. Make sure **URL** is selected in **Audit destination** and select **Browse**:

        :::image type="content" source="media/auditing-configure/11-audit-browse.png" alt-text="Screenshot showing how to Browse Azure Storage.":::
